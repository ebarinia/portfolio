...
const About = () => {
    ...
    return ( 
        ...
        <img className="face shadow" src={require("../images/annoyed.jpg")} alt="my face" />
        <div className="text">   
        ...
        <br></br>
        <h6>I have experience and built projects with the following programming languages & techology:</h6>
