...
const Portfolio = () => {
    return ( 
        <ul class="list-unstyled container portfolio">
            ...
            <img class="img-thumbnail" src={require("../../images/temp.jpg")} alt="Generic placeholder"></img>
            <div>
            <h5>Item Explorer</h5>
            ...
            <a className='btn' href='https://github.com/ebarinia/Warehouse_project'>View on Github</a>
            </div>
            </li>

            <li className='projects'>
            <img class="img-thumbnail" src={require("../../images/imbd.png")} alt="Generic placeholder"></img>
            <div>
            <h5>IMBD</h5>
            ...
            <a className='btn' href='https://github.com/ebarinia/IMBD'>View on Github</a>
            </div>
            </li>
            ...
            <a className='btn' href='https://github.com/ebarinia/e-commerce'>View on Github</a>
            </div>
            </li>
            ...
            <a className='btn' href='https://github.com/ebarinia/todo-list'>View on Github</a>
            </div>
            </li>
        </ul>
        );
